...
export const PEOPLE: Person[] = [
  ...
  },
  {
    ...
    bio: "Professionally works as a GRC engineer (you read that right) who focuses on validating security controls, network configurations, and reverse engineering software to assess their risk. Personally enjoys blogging about various cyber topics, especially malware research. Will one day create a sigma rule that works.",
    links: {
